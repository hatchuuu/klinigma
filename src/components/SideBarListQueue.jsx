...
import { Calendar, ChevronRight, House, Menu, User } from "lucide-react"
                                ...
                                <AccordionTrigger>
                                    <div className="flex justify-between px-5">
                                        ...
                                        {value.status == "Created"
                                            ? (<p className="bg-green-400 py-1 px-3 rounded-sm text-sm ">Dibuat</p>)
                                            : (<p className="bg-blue-400 py-1 px-3 rounded-sm text-sm">Menunggu</p>)
                                        }
                                    </div>

                                </AccordionTrigger>
                                <AccordionContent className="flex flex-col justify-end items-end gap-1">
                                    <Button variant="secondary" className="py-4 px-2">Batalkan</Button>
                                </AccordionContent>
                            </AccordionItem>
                        ))}
                    </Accordion>
